...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field 'score desc, years_published_itm desc, display_title_text_str asc', label: 'Relevance'
    config.add_sort_field 'years_published_itm desc, display_title_text_str asc', label: 'Year Published'
    #config.add_sort_field 'display_author_text_str asc, display_title_text_str asc', label: 'author'
    config.add_sort_field 'display_title_text_str asc, years_published_itm desc', label: 'Title'
